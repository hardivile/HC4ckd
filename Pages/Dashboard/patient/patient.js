...
document.addEventListener('DOMContentLoaded', function() {
    ...
    patientForm.addEventListener('submit', function(e) {
        ...
        const newPatient = {
            ...
            stadeMRC: "En attente de l'analyse", // Nouveau statut par défaut
    ...
    function loadPatients() {
        ...
        patients.forEach((patient, index) => {
            ...
            row.innerHTML = `
                ...
                <td>${patient.stadeMRC === "En attente de l'analyse" ? patient.stadeMRC : `Stade ${patient.stadeMRC}`}</td>
                <td>${patient.dernierExamen || 'N/A'}</td>
                <td class="action-btns">
                    <a href="patient-details.html?id=${patient.id}" class="view-btn" title="Voir">👁️</a>
    ...
    // Ajoutez cette partie à la fin du fichier, avant la dernière accolade fermante
// de l'événement DOMContentLoaded

// Expose les fonctions via l'objet window
